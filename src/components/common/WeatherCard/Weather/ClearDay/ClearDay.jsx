...
import styles from "./ClearDay.module.css";

import clearDayBackImg from "../../../../../assets/WeatherImg/ClearDay/ClearDayBackImg.png";
import sunImg from "../../../../../assets/WeatherImg/ClearDay/clearDay_SunImg.png";
...
const ClearDay = () => {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url(${clearDayBackImg})`,
            }}
        >
